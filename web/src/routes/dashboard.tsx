  ...
  return (
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
        {/* Recent executions */}
        <div className="lg:col-span-3 bg-card border border-border rounded-xl animate-slide-up" style={{ animationDelay: '200ms' }}>
          <div className="flex items-center justify-between px-5 py-4 border-b border-border">
            <h2 className="font-mono text-[11px] uppercase tracking-[0.22em] text-muted-foreground">Recent Executions</h2>
            ...
            {loading ? (
              ...
              return (
                <div key={ex.id} className="flex items-center gap-3 px-5 py-3.5 text-sm hover:bg-muted/30 transition-colors animate-slide-up" style={{ animationDelay: `${220 + i * 30}ms` }}>
                  <span className={`w-1.5 h-1.5 rounded-full shrink-0 ${dotColor} ${ex.status === 'running' ? 'animate-pulse' : ''}`} />
        ...
        {/* Jobs list */}
        <div className="lg:col-span-2 bg-card border border-border rounded-xl animate-slide-up" style={{ animationDelay: '250ms' }}>
          <div className="flex items-center justify-between px-5 py-4 border-b border-border">
            <h2 className="font-mono text-[11px] uppercase tracking-[0.22em] text-muted-foreground">Jobs</h2>
